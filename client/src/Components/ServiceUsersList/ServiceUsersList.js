...
import {getUsers_by_job_region} from "../../JS/actions/serviceuser";
    ...
    return (   
        ...
        <div>
             <div className='directionForm'>
               ...
               <button onClick={()=>{ dispatch(getUsers_by_job_region(job,region)),history.push(`/service_list/${job}/${region}`) }} >Search</button>
               </div>
               <div className="box">  
